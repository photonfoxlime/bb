...
pub struct AmplificationDraftRecord {
    /// Proposed rewrite of the target block text.
    pub rewrite: Option<String>,
    /// Suggested child block texts generated by amplification.
...
pub struct AtomizationDraftRecord {
    ...
    #[serde(default)]
    pub rewrite: Option<String>,
    /// Distinct information points extracted from the original block.
...
pub struct InstructionDraftRecord {
    /// The user-authored instruction text.
...
pub struct ProbeDraftRecord {
    /// The user's probe question text.
    pub inquiry: String,
    /// The LLM-generated response to the probe.
    pub response: String,
}
...
impl BlockStore {
    ...
    /// Get the instruction draft for a block, if any.
    ...
    /// Remove the instruction draft for a block, returning the removed draft if any.
